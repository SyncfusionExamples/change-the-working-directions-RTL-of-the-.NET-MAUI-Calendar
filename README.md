...
This repository contains a sample to change the working directions (RTL) of the [SfCalendar](https://help.syncfusion.com/maui/calendar/getting-started) control.
